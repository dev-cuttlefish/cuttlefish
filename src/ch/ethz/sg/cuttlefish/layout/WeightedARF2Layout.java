 ...
 */
public class WeightedARF2Layout<V, E> extends AbstractLayout<Vertex, Edge> implements IterativeContext {
	...
	/**
	 * The minimum and maximum weight in the graph, the actual weight
	 * is scaled to this interval
	 */
	 ...
	 * @param g
	 */
	public WeightedARF2Layout(Graph<Vertex, Edge> g) {
		super(g);
	 ...
	 * @param incremental
	 */
	public WeightedARF2Layout(Graph<Vertex, Edge> g, boolean incremental) {
		super(g);
	...
	public WeightedARF2Layout(Graph<Vertex, Edge> g, boolean incremental, Layout<Vertex, Edge> init) {
		super(g);
		this.incremental = incremental;
	...
	public WeightedARF2Layout(Graph<Vertex, Edge> g, boolean incremental, int maxUpdates) {		
		super(g);
	...
	/*
	 * Find the minimum weight, it should be scaled to 1
	 * this is in case the weights are less than 1, as this would cause
	 * 
	 * We compute alpha and beta, the scaled weigh is	 
	 * w'= alpha*w + beta
	 */
