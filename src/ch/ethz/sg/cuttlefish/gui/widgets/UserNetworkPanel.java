...
public class UserNetworkPanel extends BrowserWidget {
	 ...
	 * 
	 */
	public UserNetworkPanel() {
		super();
		initialize();
		setNetworkClass(UserNetwork.class);
	}
		...
		if (loadButton == null) {
			...
			loadButton.addActionListener(new java.awt.event.ActionListener() {
				public void actionPerformed(java.awt.event.ActionEvent e) {
					...
					int returnVal = fc.showOpenDialog(UserNetworkPanel.this);

		            if (returnVal == JFileChooser.APPROVE_OPTION) {
		                File file = fc.getSelectedFile();
		                UserNetwork uNet = (UserNetwork) getNetwork();
		                uNet.load(file);
		                setNetwork(uNet);
